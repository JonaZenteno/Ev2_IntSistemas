...
@Component
public class Empresa2Integration {

    public void enviarMensaje(Mensaje mensaje) {
        // Aquí se implementaría la lógica de integración con la Empresa 2
        // para enviar el mensaje a su sistema de mensajería
        
        // Ejemplo de código ficticio para enviar el mensaje
        System.out.println("Enviando mensaje a la Empresa 2: " + mensaje.getTexto());
    }
}